...
const certifications = [
  {
    ...
    tags: ['Security Operations', 'Threat & Vulnerability Management', 'Security Architecture', 'Risk Management', 'Identity & Access Management (IAM)'],
  },
  {
    ...
    tags: ['Cybersecurity Analysis', 'SIEM Tools', 'Threat Assessment', 'Incident Response', 'Network Security'],
  },
  {
    ...
    <section id="certifications" className="scroll-mt-16 md:mb-24 lg:mb-36 lg:scroll-mt-24">
      ...
      <div className="flex flex-col gap-12">
        {certifications.map((cert, index) => (
          <div 
            key={index}
            className="group transition-all duration-300 ease-in-out hover:!opacity-100 group-hover/list:opacity-50 p-4 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800/50"
          >
